...
O workflow do GitHub gera artifact versionado. Na versao atual, o artifact fica como `secret-fix-v0.3-win-x64` e o executavel dentro dele fica como `secret-fix-v0.3.exe`.
