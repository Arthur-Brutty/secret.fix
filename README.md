...
O workflow do GitHub gera artifact versionado. Na versão atual, o artifact fica como `secret-fix-v0.4-win-x64` e o executável dentro dele fica como `secret-fix-v0.4.exe`.
